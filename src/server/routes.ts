...
const CONTENT_STEPS: DemoScenarioStep[] = [
  {
    merchant: "전통 금융의 블록체인 수익 구조",
    amountKrw: 150,
    category: "content",
    endpoint: "/api/premium/content/brief-1",
    usdcPrice: "0.005",
    detail: "전통 금융의 블록체인 수익 구조",
  },
  {
    merchant: "스테이블코인 특화 L1의 부상",
    amountKrw: 150,
    category: "content",
    endpoint: "/api/premium/content/brief-2",
    usdcPrice: "0.005",
    detail: "스테이블코인 특화 L1의 부상",
  },
  {
    merchant: "코빗 리서치센터 2026 가상자산 전망",
    amountKrw: 150,
    category: "content",
    endpoint: "/api/premium/content/brief-3",
    usdcPrice: "0.005",
    detail: "코빗 리서치센터 2026 가상자산 전망",
  },
  {
    merchant: "무한 자금 루프: 세일러의 DAT 로드맵",
    amountKrw: 150,
    category: "content",
    endpoint: "/api/premium/content/brief-4",
    usdcPrice: "0.005",
    detail: "무한 자금 루프: 세일러의 DAT 로드맵",
  },
  {
    merchant: "기관 자금 동향: ETF 시장 업데이트",
    amountKrw: 150,
    category: "content",
    endpoint: "/api/premium/content/brief-5",
    usdcPrice: "0.005",
    detail: "기관 자금 동향: ETF 시장 업데이트",
  },
];
...
[범위]
- KTX 열차 예약에 관한 대화만 처리합니다.
- 날씨, 맛집, 관광지, 숙박, 일반 질문 등 예약과 무관한 요청에는 "KTX 예약 관련 질문만 도와드릴 수 있어요." 라고만 답하세요.
- 역 위치, 소요 시간, 열차 등급 등 예약 진행에 직접 도움이 되는 질문은 답변할 수 있습니다.
