            ...
            <div class="accordion-body" id="acc-bd-0">
              <div class="accordion-inner">
                ...
                <div id="m2-list" class="list">
                  ...
                  <div class="list-item" id="m2-item-1" data-price="0.005" data-idx="1" onclick="var cb=$('m2-cb-1');cb.checked=!cb.checked;updateM2Btn();" style="cursor:pointer"><input type="checkbox" class="m2-cb" id="m2-cb-1"><span class="m2-check"></span><div class="list-item-info" style="flex:1;margin-left:10px"><span class="list-item-title">스테이블코인 특화 L1의 부상</span><span class="list-item-price">0.005 USDC</span></div><span class="chip" id="m2-chip-1">미결제</span></div>
                  <div class="list-item" id="m2-item-2" data-price="0.005" data-idx="2" onclick="var cb=$('m2-cb-2');cb.checked=!cb.checked;updateM2Btn();" style="cursor:pointer"><input type="checkbox" class="m2-cb" id="m2-cb-2"><span class="m2-check"></span><div class="list-item-info" style="flex:1;margin-left:10px"><span class="list-item-title">2026년 가상자산 시장 전망</span><span class="list-item-price">0.005 USDC</span></div><span class="chip" id="m2-chip-2">미결제</span></div>
                  <div class="list-item" id="m2-item-3" data-price="0.005" data-idx="3" onclick="var cb=$('m2-cb-3');cb.checked=!cb.checked;updateM2Btn();" style="cursor:pointer"><input type="checkbox" class="m2-cb" id="m2-cb-3"><span class="m2-check"></span><div class="list-item-info" style="flex:1;margin-left:10px"><span class="list-item-title">무한 자금 루프: 세일러의 DAT 로드맵</span><span class="list-item-price">0.005 USDC</span></div><span class="chip" id="m2-chip-3">미결제</span></div>
                  <div class="list-item" id="m2-item-4" data-price="0.005" data-idx="4" onclick="var cb=$('m2-cb-4');cb.checked=!cb.checked;updateM2Btn();" style="cursor:pointer"><input type="checkbox" class="m2-cb" id="m2-cb-4"><span class="m2-check"></span><div class="list-item-info" style="flex:1;margin-left:10px"><span class="list-item-title">기관 자금 동향: ETF 시장 업데이트</span><span class="list-item-price">0.005 USDC</span></div><span class="chip" id="m2-chip-4">미결제</span></div>
                </div>
                <button class="btn" id="m2-run" onclick="runMicropayment()" style="margin-top:12px">전체 결제 실행 (0.0250 USDC)</button>
    ...
    '<div style="display:flex;align-items:center;gap:10px;padding:10px 0;' + border + '">' +
      ...
      '<div style="text-align:right;flex-shrink:0">' +
        ...
        '<div style="display:flex;align-items:center;gap:4px;justify-content:flex-end;margin-top:2px">' +
          (isOk ? '' : '<span style="font-size:10px;font-weight:600;color:var(--danger)">차단</span>') +
